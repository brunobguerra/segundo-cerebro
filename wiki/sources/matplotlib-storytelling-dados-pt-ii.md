...
lang: pt-BR
sources:
  - "`raw/clippings/Matplotlib e Storytelling com Dados 1.md`"
updated: 2026-04-21
...
Continuação direta da [[wiki/sources/matplotlib-storytelling-dados-pt-i|Matplotlib e Storytelling com Dados — Pt. I]], por [[wiki/entities/henrique-w-franco|Henrique W. Franco]] (Medium / **Data Hackers**): parte **prática** de um gráfico de linhas com técnicas do livro [[wiki/concepts/storytelling-com-dados|Storytelling com Dados (livro e princípios)]].

## Onde está a fonte

- Clipping: `raw/clippings/Matplotlib e Storytelling com Dados 1.md`
...
- **Disciplina central:** não apresentar [[wiki/concepts/analise-exploratoria-vs-explanatoria|análise exploratória]] no lugar da **explanatória** quando o objetivo é comunicar uma mensagem.
...
Resumo alinhado à nota [[wiki/concepts/matplotlib|Matplotlib]]:
