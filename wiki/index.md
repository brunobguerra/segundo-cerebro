...
Este arquivo é o **catálogo orientado a conteúdo** da wiki. O agente deve **atualizar** `wiki/index.md` após cada ingestão bem-sucedida e após consultas que criarem páginas novas relevantes.
...
_(análises ou respostas que você pediu para arquivar na wiki.)_

## Registro cronológico

Ver também **`wiki/log.md`** (linha do tempo append-only).

---

<!-- AGENT: After every ingest, refresh section links/summaries here to match new pages. -->
