...
Biblioteca de visualização em Python (inspirada em gráficos estilo MATLAB), útil para exploração e para gráficos publicáveis quando combinada com bom desenho visual e narrativa — ver [[B03 Resources/concepts/storytelling-com-dados|Storytelling com Dados (livro e princípios)]] e as fontes [[B03 Resources/sources/matplotlib-storytelling-dados-pt-i|Pt. I]] / [[B03 Resources/sources/matplotlib-storytelling-dados-pt-ii|Pt. II]] da série Data Hackers.
...
Padrões úteis quando o objetivo é um gráfico **explanatório** (não só EDA rápida), como na [[B03 Resources/sources/matplotlib-storytelling-dados-pt-ii|Pt. II]] da série citada:
