...
lang: pt-BR
sources:
  - "`A00 Inbox/clippings/Matplotlib e Storytelling com Dados.md`"
updated: 2026-04-21
...
Artigo em duas partes no blog **Data Hackers** (Medium), por [[B03 Resources/entities/henrique-w-franco|Henrique W. Franco]], conectando [[B03 Resources/concepts/storytelling-com-dados|Storytelling com Dados (livro e princípios)]] com prática em [[B03 Resources/concepts/matplotlib|Matplotlib]].

## Onde está a fonte

- Clipping: `A00 Inbox/clippings/Matplotlib e Storytelling com Dados.md`
...
2. **Objetivo da série** — Pt. I explica *como* o Matplotlib funciona; a Pt. II (tutorial com queimadas no Brasil) está resumida em [[B03 Resources/sources/matplotlib-storytelling-dados-pt-ii|Matplotlib e Storytelling com Dados — Pt. II]].
3. **Hierarquia** — [[B03 Resources/concepts/matplotlib|Matplotlib]] organiza o desenho em Figure → Axes → Axis → Artist; uma Figure pode ter vários Axes (ver a nota de conceito).
...
- [[B03 Resources/entities/henrique-w-franco|Henrique W. Franco]]
